...
image:https://coveralls.io/repos/github/Arquisoft/dechat_en3b/badge.svg["Coverage status", link="https://coveralls.io/github/Arquisoft/dechat_en3b?branch=master"]
...
image:https://inch-ci.org/github/arquisoft/dechat_en3b.svg?branch=master["Docs", link="https://inch-ci.org/github/arquisoft/dechat_en3b"]
